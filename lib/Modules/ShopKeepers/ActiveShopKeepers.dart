...
class ActiveShopKeepersPage extends StatefulWidget {
  const ActiveShopKeepersPage({super.key});

  @override
  State<ActiveShopKeepersPage> createState() => _ActiveShopKeepersPageState();
}

class _ActiveShopKeepersPageState extends State<ActiveShopKeepersPage> {
  ...
  String? selectedLease;
  List<String> lease = ["Active", "Expired", "< 30 days", "< 60 days", "< 90 days"];
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(height: 15,),
                      Text("Add New Venders",style: TextStyle(fontSize: 20),),
                      SizedBox(height: 15,),
                      SizedBox(
                          width: 130,
                          height: 40,
