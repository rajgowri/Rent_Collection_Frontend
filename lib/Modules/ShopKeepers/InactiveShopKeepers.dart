...
class InactiveShopKeepersPage extends StatefulWidget {
  const InactiveShopKeepersPage({super.key});

  @override
  State<InactiveShopKeepersPage> createState() => _InactiveShopKeepersPageState();
}

class _InactiveShopKeepersPageState extends State<InactiveShopKeepersPage> {
