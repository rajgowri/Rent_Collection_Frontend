...
class TotalAdditional extends StatefulWidget {
  const TotalAdditional({super.key});

  @override
  State<TotalAdditional> createState() => _TotalAdditionalState();
}

class _TotalAdditionalState extends State<TotalAdditional> {
      ...
      home: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              Text("Total Additional",style: TextStyle(fontSize: 25),)
            ],
          ),
        ),
      ),
