...
class TotalRent extends StatefulWidget {
  const TotalRent({super.key});

  @override
  State<TotalRent> createState() => _TotalRentState();
}

class _TotalRentState extends State<TotalRent> {
      ...
      home: Scaffold(
        ...
        body: Container(
          ...
          child: Column(
            ...
            children: [
              Text("Total Rent",style: TextStyle(fontSize: 25),)
            ],
          ),
        ),
      ),
