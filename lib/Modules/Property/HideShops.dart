...
class HideShopsPage extends StatefulWidget {
  const HideShopsPage({super.key});

  @override
  State<HideShopsPage> createState() => _HideShopsPageState();
}

class _HideShopsPageState extends State<HideShopsPage> {
              ...
              children: [
                ...
                Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        SizedBox(height: 10,),
                        Text("Hide", style: TextStyle(fontSize: 25)),
                        SizedBox(height: 20),
                        TextField(
                        ...
                        SizedBox(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: (){}, child: Text("Hide Shop")))
                      ],
                    )
                ),
              ],
