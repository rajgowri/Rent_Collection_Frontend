                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          onChanged: (newValue) {
                            setState(() {
                              ...
                              if (newValue == "Furniture") {
                                subCategories = ["Table", "Chair", "Bed", "Sofa"];
                              } else if (newValue == "Electrical Appliances") {
                                subCategories = ["Fan", "Light", "TV", "Refrigerator"];
                              } else if (newValue == "Others") {
                                subCategories = ["Water Purifier", "Mirror"];
                              }
                            });
                          },
                          decoration: InputDecoration(
                            labelText: "Select Asset Category",
                            border: OutlineInputBorder(),
                          ),
                        ),
                        SizedBox(height: 10,),
                        DropdownButtonFormField<String>(
                          ...
                          decoration: InputDecoration(
                            labelText: "Select Asset Subcategory",
                            border: OutlineInputBorder(),
                          ),
                        ),
                        SizedBox(height: 10,),
